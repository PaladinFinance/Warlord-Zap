...
contract Uniswap {
    ...
    function _approveSwapper(address token) external {// TODO internalize 
    ...
    function _etherize(address token, uint256 amountIn, uint256 etherOutMin, address receiver)
        external //  TODO change this
        returns (uint256 amountOut)
    {
        ...
        ISwapRouter.ExactInputSingleParams memory params = ISwapRouter.ExactInputSingleParams({
            ...
            recipient: receiver, // Receiver of the swapped tokens
